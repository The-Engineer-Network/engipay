                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => position.type === "Supply" 
                      ? handleWithdraw(position.asset, position.amount)
                      : handleRepay(position.asset, position.amount)
                    }
