...
mod Treasury {
    ...
    use crate::libraries::SafeMath;
    use crate::libraries::AccessControl::{
        AccessControlComponent, DEFAULT_ADMIN_ROLE, PAUSER_ROLE
    };
    use AccessControlComponent::AccessControlInternalTrait;
    use crate::libraries::ReentrancyGuard::{ReentrancyGuardComponent};
    use ReentrancyGuardComponent::ReentrancyGuardInternalTrait;

    component!(path: AccessControlComponent, storage: access_control, event: AccessControlEvent);
    component!(path: ReentrancyGuardComponent, storage: reentrancy_guard, event: ReentrancyGuardEvent);

    impl AccessControlImpl = AccessControlComponent::AccessControlInternalImpl<ContractState>;
    impl ReentrancyGuardImpl = ReentrancyGuardComponent::ReentrancyGuardInternalImpl<ContractState>;
    ...
    // Internal functions
    #[generate_trait]
    impl TreasuryInternalImpl of TreasuryInternalTrait {
        ...
        fn _validate_allocation_rates(self: @ContractState, rates: @AllocationRates) {
            ...
            assert(total == 100_u256, Errors::INVALID_ALLOCATION); // Must sum to 100%
        }
        ...
        fn _allocate_funds(ref self: ContractState, token: ContractAddress, amount: u256) {
            ...
            let dev_allocation = SafeMath::div(SafeMath::mul(amount, rates.development), 100_u256);
