...
/** Scrypt KDF */ export function scrypt(password, salt) {
...
/** PBKDF2-HMAC-SHA256 */ export function pbkdf2(password, salt) {
 ...
 */ function getSaltInfo(protocol, accountId = 0) {
  ...
  if (typeof accountId === 'string') {
    ...
    if (!strHasLength(accountId, 1, 255)) throw new Error('accountId must be string of length 1..255');
