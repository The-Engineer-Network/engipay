...
/** Internal SHA1 legacy hash class. */ export class _SHA1 extends HashMD {
  A = SHA1_IV[0] | 0;
  B = SHA1_IV[1] | 0;
  C = SHA1_IV[2] | 0;
  D = SHA1_IV[3] | 0;
...
/** SHA1 (RFC 3174) legacy hash function. It was cryptographically broken. */ export const sha1 = /* @__PURE__ */ createHasher(()=>new _SHA1());
...
/** Internal MD5 legacy hash class. */ export class _MD5 extends HashMD {
  A = MD5_IV[0] | 0;
  B = MD5_IV[1] | 0;
  C = MD5_IV[2] | 0;
  D = MD5_IV[3] | 0;
