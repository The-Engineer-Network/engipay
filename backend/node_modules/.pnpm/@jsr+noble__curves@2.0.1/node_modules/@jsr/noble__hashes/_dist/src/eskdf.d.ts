/** Scrypt KDF */ export declare function scrypt(password: string, salt: string): Uint8Array;
/** PBKDF2-HMAC-SHA256 */ export declare function pbkdf2(password: string, salt: string): Uint8Array;
/**
...
/** Not using classes because constructor cannot be async */ export interface ESKDF {
  /**
