 ...
 * Do not use for now.
 * @module
 */ /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ import { sha256, sha384, sha512 } from "@jsr/noble__hashes/sha2.js";
...
/** Hashing / encoding to p256 points / field. RFC 9380 methods. */ export const p256_hasher = /* @__PURE__ */ (()=>{
...
/** p256 OPRF, defined in RFC 9497. */ export const p256_oprf = /* @__PURE__ */ (()=>createORPF({
    name: 'P256-SHA256',
    Point: p256_Point,
    hash: sha256,
...
/** NIST P384 (aka secp384r1) curve, ECDSA and ECDH methods. Hashes inputs with sha384 by default. */ export const p384 = /* @__PURE__ */ ecdsa(p384_Point, sha384);
/** Hashing / encoding to p384 points / field. RFC 9380 methods. */ export const p384_hasher = /* @__PURE__ */ (()=>{
...
/** p384 OPRF, defined in RFC 9497. */ export const p384_oprf = /* @__PURE__ */ (()=>createORPF({
    name: 'P384-SHA384',
    Point: p384_Point,
    hash: sha384,
...
// NIST P521
const Fn521 = /* @__PURE__ */ (()=>Field(p521_CURVE.n, {
    allowedLengths: [
      65,
      66
    ]
...
/** NIST P521 (aka secp521r1) curve, ECDSA and ECDH methods. Hashes inputs with sha512 by default. */ export const p521 = /* @__PURE__ */ ecdsa(p521_Point, sha512);
/** Hashing / encoding to p521 points / field. RFC 9380 methods. */ export const p521_hasher = /* @__PURE__ */ (()=>{
...
/** p521 OPRF, defined in RFC 9497. */ export const p521_oprf = /* @__PURE__ */ (()=>createORPF({
    name: 'P521-SHA512',
    Point: p521_Point,
    hash: sha512,
