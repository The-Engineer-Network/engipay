...
/** Use `gcmsiv` or `aessiv`. */ export const siv = ()=>{
 ...
 */ export const aessiv = /* @__PURE__ */ wrapCipher({
  ...
  if (![
    ...
    48,
    64
  ].includes(key.length)) throw new Error('"aes key" expected Uint8Array of length 32/48/64, got length=' + key.length);
...
//#endregion
/** Unsafe low-level internal methods. May change at any time. */ export const unsafe = {
  expandKeyLE,
  expandKeyDecLE,
  encrypt,
  decrypt,
