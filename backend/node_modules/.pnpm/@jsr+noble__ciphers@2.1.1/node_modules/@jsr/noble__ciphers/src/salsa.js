 ...
 */ /** quarter-round */ function salsaQR(x, a, b, c, d) {
...
/** Small version of salsa without loop unrolling. Unused, provided for auditability. */ // prettier-ignore
...
/** Identical to `salsaCore`. Unused. */ // @ts-ignore
const salsaCore_small = (s, k, n, out, cnt, rounds)=>salsa(s, k, Uint32Array.from([
    n[0],
    n[1],
    cnt,
    0
  ]), out, false, rounds);
/** Identical to `hsalsa`. Unused. */ // @ts-ignore
const hsalsa_small = salsa;
/** Identical to `salsaCore_small` */ // prettier-ignore
function salsaCore(s, k, n, out, cnt, rounds = 20) {
  // Based on https://cr.yp.to/salsa20.html
  let y00 = s[0], y01 = k[0], y02 = k[1], y03 = k[2], y04 = k[3], y05 = s[1], y06 = n[0], y07 = n[1], y08 = cnt, y09 = 0, y10 = s[2], y11 = k[4], y12 = k[5], y13 = k[6], y14 = k[7], y15 = s[3]; // Key    Key     Key     "te k"
...
/** xsalsa20 eXtended-nonce salsa. With 24-byte nonce, it's safe to make it random (CSPRNG). */ export const xsalsa20 = /* @__PURE__ */ createCipher(salsaCore, {
  counterRight: true,
