...
/** AES-CBC, native webcrypto version */ export declare const cbc: ((key: Uint8Array, iv: Uint8Array) => AsyncCipher) & {
  blockSize: number;
  nonceLength: number;
};
/** AES-CTR, native webcrypto version */ export declare const ctr: ((key: Uint8Array, nonce: Uint8Array) => AsyncCipher) & {
  blockSize: number;
  nonceLength: number;
};
/** AES-GCM, native webcrypto version */ export declare const gcm: ((key: Uint8Array, nonce: Uint8Array, AAD?: Uint8Array) => AsyncCipher) & {
  blockSize: number;
  nonceLength: number;
};
