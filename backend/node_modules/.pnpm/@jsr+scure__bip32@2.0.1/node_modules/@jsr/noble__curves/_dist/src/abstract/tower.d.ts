...
import type { WeierstrassPoint, WeierstrassPointCons } from "./weierstrass.js";
...
export type BigintTwelve = [bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint];
