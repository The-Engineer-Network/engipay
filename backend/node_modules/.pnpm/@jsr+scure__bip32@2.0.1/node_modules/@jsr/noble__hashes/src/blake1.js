...
function G1b(a, b, c, d, msg, k) {
  ...
  ({ Bh, Bl } = {
    Bh: u64.rotrSH(Bh, Bl, 25),
    Bl: u64.rotrSL(Bh, Bl, 25)
  });
...
function G2b(a, b, c, d, msg, k) {
  ...
  ({ Bh, Bl } = {
    Bh: u64.rotrSH(Bh, Bl, 11),
    Bl: u64.rotrSL(Bh, Bl, 11)
  });
  BBUF[2 * a + 1] = Al, BBUF[2 * a] = Ah;
  BBUF[2 * b + 1] = Bl, BBUF[2 * b] = Bh;
  BBUF[2 * c + 1] = Cl, BBUF[2 * c] = Ch;
...
/** Internal blake1-224 hash class. */ export class _BLAKE224 extends BLAKE1_32B {
  constructor(opts = {}){
    super(28, B224_IV, 0b0000_0000, opts);
  }
}
/** Internal blake1-256 hash class. */ export class _BLAKE256 extends BLAKE1_32B {
  constructor(opts = {}){
    super(32, B256_IV, 0b0000_0001, opts);
  }
}
/** Internal blake1-384 hash class. */ export class _BLAKE384 extends BLAKE1_64B {
  constructor(opts = {}){
    super(48, B384_IV, 0b0000_0000, opts);
  }
}
/** Internal blake1-512 hash class. */ export class _BLAKE512 extends BLAKE1_64B {
  constructor(opts = {}){
    super(64, B512_IV, 0b0000_0001, opts);
  }
}
/** blake1-224 hash function */ export const blake224 = /* @__PURE__ */ createHasher((opts)=>new _BLAKE224(opts));
/** blake1-256 hash function */ export const blake256 = /* @__PURE__ */ createHasher((opts)=>new _BLAKE256(opts));
/** blake1-384 hash function */ export const blake384 = /* @__PURE__ */ createHasher((opts)=>new _BLAKE384(opts));
/** blake1-512 hash function */ export const blake512 = /* @__PURE__ */ createHasher((opts)=>new _BLAKE512(opts));
