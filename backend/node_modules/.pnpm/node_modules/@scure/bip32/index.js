 ...
 * ```
 */ /*! scure-bip32 - MIT License (c) 2022 Patricio Palladino, Paul Miller (paulmillr.com) */ import { secp256k1 as secp } from "@jsr/noble__curves/secp256k1.js";
import { hmac } from "@jsr/noble__hashes/hmac.js";
import { ripemd160 } from "@jsr/noble__hashes/legacy.js";
import { sha256, sha512 } from "@jsr/noble__hashes/sha2.js";
import { abytes, concatBytes, createView } from "@jsr/noble__hashes/utils.js";
import { createBase58check } from "@jsr/scure__base";
...
/** Hardened offset from Bitcoin, default */ export const HARDENED_OFFSET = 0x80000000;
 ...
 */ export class HDKey {
  ...
  sign(hash) {
    ...
    abytes(hash, 32);
    return secp.sign(hash, this._privateKey, {
      prehash: false
    });
  }
  verify(hash, signature) {
    ...
    return secp.verify(signature, hash, this._publicKey, {
      prehash: false
    });
  }
  wipePrivateData() {
  ...
  serialize(version, key) {
    ...
    abytes(key, 33);
    // version(4) || depth(1) || fingerprint(4) || index(4) || chain(32) || key(33)
    return concatBytes(toU32(version), new Uint8Array([
      this.depth
