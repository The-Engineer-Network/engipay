 ...
 * @module
 **/ /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ import { abytes, memoized, notImplemented, randomBytes } from "../utils.js";
...
function createBlsSig(blsPairing, PubPoint, SigPoint, isSigG1, hashToSigCurve, SignatureCoder) {
  ...
  function amsg(m) {
    if (!(m instanceof SigPoint)) throw new Error(`expected valid message hashed to ${!isSigG1 ? 'G2' : 'G1'} curve`);
    return m;
  }
