 ...
 * @module
 */ /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ import { abytes, anumber, bytesToNumberBE, bytesToNumberLE, numberToBytesBE, numberToBytesLE, validateObject } from "../utils.js";
...
/** Does `x^(2^power)` mod p. `pow2(30, 4)` == `30^(2^4)` */ export function pow2(x, power, modulo) {
  let res = x;
  while(power-- > _0n){
    res *= res;
    res %= modulo;
