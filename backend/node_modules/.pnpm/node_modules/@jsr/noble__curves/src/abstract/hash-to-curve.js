 ...
 * @module
 */ /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ import { abytes, asafenumber, asciiToBytes, bytesToNumberBE, concatBytes, isBytes, validateObject } from "../utils.js";
...
export function isogenyMap(field, map) {
  ...
  return (x, y)=>{
    ...
    const [xd_inv, yd_inv] = FpInvertBatch(field, [
      xd,
      yd
    ], true);
...
/** Creates hash-to-curve methods from EC Point and mapToCurve function. See {@link H2CHasher}. */ export function createHasher(Point, mapToCurve, defaults) {
