 ...
 * @module
 */ /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ /** Raw type */ const TYPE_RAW = 'raw';
const TYPE_JWK = 'jwk';
...
function createKeygenA(randomSecretKey, getPublicKey) {
  return async function keygenA(_seed) {
    ...
    return {
      secretKey,
      publicKey: await getPublicKey(secretKey)
    };
  };
}
...
function createKeyUtils(algo, derive, keyLen, pkcs8header) {
  const secUsage = derive ? [
    'deriveBits'
  ] : [
    'sign'
  ];
  const pubUsage = derive ? [] : [
    'verify'
  ];
...
/** Friendly wrapper over built-in WebCrypto NIST P-256 (secp256r1). */ export const p256 = /* @__PURE__ */ wrapECDSA('P-256', 'SHA-256', 32, '3041020100301306072a8648ce3d020106082a8648ce3d030107042730250201010420');
...
/** Friendly wrapper over built-in WebCrypto NIST P-521 (secp521r1). */ export const p521 = /* @__PURE__ */ wrapECDSA('P-521', 'SHA-512', 66, '3060020100301006072a8648ce3d020106052b81040023044930470201010442');
/** Friendly wrapper over built-in WebCrypto ed25519. */ export const ed25519 = /* @__PURE__ */ wrapEdDSA('Ed25519', 32, '302e020100300506032b657004220420');
/** Friendly wrapper over built-in WebCrypto ed448. */ export const ed448 = /* @__PURE__ */ wrapEdDSA('Ed448', 57, '3047020100300506032b6571043b0439');
/** Friendly wrapper over built-in WebCrypto x25519 (ECDH over Curve25519). */ export const x25519 = /* @__PURE__ */ wrapMontgomery('X25519', 32, '302e020100300506032b656e04220420');
/** Friendly wrapper over built-in WebCrypto x448 (ECDH over Curve448). */ export const x448 = /* @__PURE__ */ wrapMontgomery('X448', 56, '3046020100300506032b656f043a0438');
