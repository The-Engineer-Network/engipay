 ...
 * @module
 */ /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ import { shake256 } from "@jsr/noble__hashes/sha3.js";
import { concatBytes, hexToBytes, createHasher as wrapConstructor } from "@jsr/noble__hashes/utils.js";
...
const shake256_114 = /* @__PURE__ */ wrapConstructor(()=>shake256.create({
    dkLen: 114
  }));
const shake256_64 = /* @__PURE__ */ wrapConstructor(()=>shake256.create({
    dkLen: 64
  }));
// prettier-ignore
...
const Fp = /* @__PURE__ */ (()=>Field(ed448_CURVE_p, {
    BITS: 456,
    isLE: true
  }))();
const Fn = /* @__PURE__ */ (()=>Field(ed448_CURVE.n, {
    BITS: 456,
    isLE: true
  }))();
// decaf448 uses 448-bit (56-byte) keys
const Fp448 = /* @__PURE__ */ (()=>Field(ed448_CURVE_p, {
    BITS: 448,
    isLE: true
  }))();
const Fn448 = /* @__PURE__ */ (()=>Field(ed448_CURVE.n, {
    BITS: 448,
    isLE: true
  }))();
...
function dom4(data, ctx, phflag) {
  ...
  return concatBytes(asciiToBytes('SigEd448'), new Uint8Array([
    phflag ? 1 : 0,
    ctx.length
  ]), ctx, data);
}
const ed448_Point = /* @__PURE__ */ edwards(ed448_CURVE, {
  Fp,
  Fn,
  uvRatio
});
...
/** Prehashed version of ed448. See {@link ed448} */ export const ed448ph = /* @__PURE__ */ ed4({
  prehash: shake256_64
});
/**
...
/** Hashing / encoding to ed448 points / field. RFC 9380 methods. */ export const ed448_hasher = /* @__PURE__ */ (()=>createHasher(ed448_Point, (scalars)=>map_to_curve_elligator2_edwards448(scalars[0]), {
 ...
 */ class _DecafPoint extends PrimeEdwardsPoint {
  ...
  // prettier-ignore
  static BASE = /* @__PURE__ */ (()=>new _DecafPoint(ed448_Point.BASE).multiplyUnsafe(_2n))();
  // prettier-ignore
  static ZERO = /* @__PURE__ */ (()=>new _DecafPoint(ed448_Point.ZERO))();
  // prettier-ignore
  ...
  static fromBytes(bytes) {
    ...
    if (!equalBytes(Fn448.toBytes(s), bytes) || isNegativeLE(s, P)) throw new Error('invalid decaf448 encoding 1');
    const s2 = mod(s * s); // 1
...
/** Hashing to decaf448 points / field. RFC 9380 methods. */ export const decaf448_hasher = {
  Point: _DecafPoint,
...
/** decaf448 OPRF, defined in RFC 9497. */ export const decaf448_oprf = /* @__PURE__ */ (()=>createORPF({
    name: 'decaf448-SHAKE256',
    Point: _DecafPoint,
    hash: (msg)=>shake256(msg, {
        dkLen: 64
      }),
