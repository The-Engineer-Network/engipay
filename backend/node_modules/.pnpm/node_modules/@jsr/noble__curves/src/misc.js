 ...
 * @module
 */ /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ import { blake256 } from "@jsr/noble__hashes/blake1.js";
import { blake2s } from "@jsr/noble__hashes/blake2.js";
import { sha256, sha384, sha512 } from "@jsr/noble__hashes/sha2.js";
import { concatBytes } from "@jsr/noble__hashes/utils.js";
...
/** Curve over scalar field of bls12-381. jubjub Fp = bls n */ export const jubjub = /* @__PURE__ */ eddsa(edwards(jubjub_CURVE), sha512);
...
/** Curve over scalar field of bn254. babyjubjub Fp = bn254 n */ export const babyjubjub = /* @__PURE__ */ eddsa(edwards(babyjubjub_CURVE), blake256);
...
/** Brainpool P256r1 with sha256, from RFC 5639. */ export const brainpoolP256r1 = ecdsa(weierstrass(brainpoolP256r1_CURVE), sha256);
...
/** Brainpool P384r1 with sha384, from RFC 5639. */ export const brainpoolP384r1 = ecdsa(weierstrass(brainpoolP384r1_CURVE), sha384);
...
/** Brainpool P521r1 with sha512, from RFC 5639. */ export const brainpoolP512r1 = ecdsa(weierstrass(brainpoolP512r1_CURVE), sha512);
