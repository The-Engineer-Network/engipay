...
/** 128-bit NIST cSHAKE XOF. */ export const cshake128 = /* @__PURE__ */ gencShake(0x1f, 168, 16);
/** 256-bit NIST cSHAKE XOF. */ export const cshake256 = /* @__PURE__ */ gencShake(0x1f, 136, 32);
/** Internal KMAC mac class. */ export class _KMAC extends Keccak {
...
/** 128-bit Keccak MAC. */ export const kmac128 = /* @__PURE__ */ genKmac(168, 16);
/** 256-bit Keccak MAC. */ export const kmac256 = /* @__PURE__ */ genKmac(136, 32);
/** 128-bit Keccak-MAC XOF. */ export const kmac128xof = /* @__PURE__ */ genKmac(168, 16, true);
/** 256-bit Keccak-MAC XOF. */ export const kmac256xof = /* @__PURE__ */ genKmac(136, 32, true);
/** Internal TupleHash class. */ export class _TupleHash extends Keccak {
  ...
  finish() {
    if (!this.finished) super.update(rightEncode(this.enableXOF ? 0 : _8n * BigInt(this.outputLen))); // outputLen in bits
    super.finish();
  }
  _cloneInto(to) {
...
/** 128-bit TupleHASH. tuple(['ab', 'cd']) != tuple(['a', 'bcd']) */ export const tuplehash128 = /* @__PURE__ */ genTuple(168, 16);
/** 256-bit TupleHASH. tuple(['ab', 'cd']) != tuple(['a', 'bcd']) */ export const tuplehash256 = /* @__PURE__ */ genTuple(136, 32);
/** 128-bit TupleHASH XOF. */ export const tuplehash128xof = /* @__PURE__ */ genTuple(168, 16, true);
/** 256-bit TupleHASH XOF. */ export const tuplehash256xof = /* @__PURE__ */ genTuple(136, 32, true);
/** Internal Parallel Keccak Hash class. */ export class _ParallelHash extends Keccak {
  leafHash;
  leafCons;
  chunkPos = 0;
  chunksDone = 0;
...
function genPrl(blockLen, outputLen, leaf, xof = false) {
  ...
  parallel.create = (opts = {})=>new _ParallelHash(blockLen, chooseLen(opts, outputLen), ()=>leaf.create({
        dkLen: 2 * outputLen
      }), xof, opts);
...
/** 128-bit ParallelHash. In JS, it is not parallel. */ export const parallelhash128 = /* @__PURE__ */ genPrl(168, 16, cshake128);
/** 256-bit ParallelHash. In JS, it is not parallel. */ export const parallelhash256 = /* @__PURE__ */ genPrl(136, 32, cshake256);
/** 128-bit ParallelHash XOF. In JS, it is not parallel. */ export const parallelhash128xof = /* @__PURE__ */ genPrl(168, 16, cshake128, true);
/** 256-bit ParallelHash. In JS, it is not parallel. */ export const parallelhash256xof = /* @__PURE__ */ genPrl(136, 32, cshake256, true);
const genTurbo = (blockLen, outputLen)=>createHasher((opts = {})=>{
    ...
    if (!Number.isSafeInteger(D) || D < 0x01 || D > 0x7f) throw new Error('"D" (domain separation byte) must be 0x01..0x7f, got: ' + D);
...
/** TurboSHAKE 256-bit: reduced 12-round keccak. */ export const turboshake256 = /* @__PURE__ */ genTurbo(136, 64);
...
/** Internal K12 hash class. */ export class _KangarooTwelve extends Keccak {
  chunkLen = 8192;
  leafHash;
  leafLen;
  personalization;
...
/** 128-bit KangarooTwelve (k12): reduced 12-round keccak. */ export const kt128 = /* @__PURE__ */ createHasher((opts = {})=>new _KangarooTwelve(168, 32, chooseLen(opts, 32), 12, opts));
/** 256-bit KangarooTwelve (k12): reduced 12-round keccak. */ export const kt256 = /* @__PURE__ */ createHasher((opts = {})=>new _KangarooTwelve(136, 64, chooseLen(opts, 64), 12, opts));
const genHopMAC = (hash)=>(key, message, personalization, dkLen)=>hash(key, {
      personalization: hash(message, {
        personalization
      }),
      dkLen
    });
...
/** 256-bit KangarooTwelve-based MAC. */ export const HopMAC256 = /* @__PURE__ */ genHopMAC(kt256);
/**
...
/** KeccakPRG: Pseudo-random generator based on Keccak. https://keccak.team/files/CSF-0.1.pdf */ export const keccakprg = (capacity = 254)=>new _KeccakPRG(capacity);
