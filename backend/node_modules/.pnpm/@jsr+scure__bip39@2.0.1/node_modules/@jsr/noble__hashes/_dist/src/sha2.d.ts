...
/** Internal 32-byte base SHA2 hash class. */ declare abstract class SHA2_32B<T extends SHA2_32B<T>> extends HashMD<T> {
...
/** Internal SHA2-256 hash class. */ export declare class _SHA256 extends SHA2_32B<_SHA256> {
  protected A: number;
  protected B: number;
  protected C: number;
  protected D: number;
...
/** Internal SHA2-224 hash class. */ export declare class _SHA224 extends SHA2_32B<_SHA224> {
  protected A: number;
  protected B: number;
  protected C: number;
  protected D: number;
...
/** Internal 64-byte base SHA2 hash class. */ declare abstract class SHA2_64B<T extends SHA2_64B<T>> extends HashMD<T> {
  ...
  constructor(outputLen: number);
  protected get(): [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number];
...
/** Internal SHA2-512 hash class. */ export declare class _SHA512 extends SHA2_64B<_SHA512> {
  protected Ah: number;
  protected Al: number;
  protected Bh: number;
  protected Bl: number;
...
/** Internal SHA2-384 hash class. */ export declare class _SHA384 extends SHA2_64B<_SHA384> {
  protected Ah: number;
  protected Al: number;
  protected Bh: number;
  protected Bl: number;
...
/** Internal SHA2-512/224 hash class. */ export declare class _SHA512_224 extends SHA2_64B<_SHA512_224> {
  protected Ah: number;
  protected Al: number;
  protected Bh: number;
  protected Bl: number;
...
/** Internal SHA2-512/256 hash class. */ export declare class _SHA512_256 extends SHA2_64B<_SHA512_256> {
  protected Ah: number;
  protected Al: number;
  protected Bh: number;
  protected Bl: number;
...
/** SHA2-224 hash function from RFC 4634 */ export declare const sha224: CHash<_SHA224>;
/** SHA2-512 hash function from RFC 4634. */ export declare const sha512: CHash<_SHA512>;
/** SHA2-384 hash function from RFC 4634. */ export declare const sha384: CHash<_SHA384>;
/**
