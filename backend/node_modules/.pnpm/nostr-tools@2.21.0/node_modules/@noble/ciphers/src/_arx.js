...
/** Rotate left. */ export function rotl(a, b) {
  return a << b | a >>> 32 - b;
}
...
/** Creates ARX-like (ChaCha, Salsa) cipher stream from core function. */ export function createCipher(core, opts) {
...
/** Internal class which wraps chacha20 or chacha8 to create CSPRNG. */ export class _XorStreamPRG {
  blockLen;
  keyLen;
  nonceLen;
  state;
