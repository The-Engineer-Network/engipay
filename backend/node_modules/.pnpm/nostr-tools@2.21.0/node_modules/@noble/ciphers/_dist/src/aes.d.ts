import { type Cipher, type CipherWithOutput, type PRG, type Uint8ArrayBuffer } from "./utils.js";
/** Key expansion used in CTR. */ declare function expandKeyLE(key: Uint8Array): Uint32Array;
...
/** Options for ECB and CBC. */ export type BlockOpts = {
...
/** Use `gcmsiv` or `aessiv`. */ export declare const siv: () => never;
/**
...
/** Unsafe low-level internal methods. May change at any time. */ export declare const unsafe: {
