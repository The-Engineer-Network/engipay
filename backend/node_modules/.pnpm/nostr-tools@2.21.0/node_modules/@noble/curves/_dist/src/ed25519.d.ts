import { type AffinePoint } from "./abstract/curve.js";
import { PrimeEdwardsPoint, type EdDSA, type EdwardsPoint, type EdwardsPointCons } from "./abstract/edwards.js";
import { type H2CHasher, type H2CHasherBase } from "./abstract/hash-to-curve.js";
import { type IField } from "./abstract/modular.js";
import { type MontgomeryECDH } from "./abstract/montgomery.js";
...
/** Context version of ed25519 (ctx for domain separation). See {@link ed25519} */ export declare const ed25519ctx: EdDSA;
/** Prehashed version of ed25519. See {@link ed25519} */ export declare const ed25519ph: EdDSA;
/**
...
/** Hashing to ed25519 points / field. RFC 9380 methods. */ export declare const ed25519_hasher: H2CHasher<EdwardsPointCons>;
/**
...
/** Hashing to ristretto255 points / field. RFC 9380 methods. */ export declare const ristretto255_hasher: H2CHasherBase<typeof _RistrettoPoint>;
/** ristretto255 OPRF, defined in RFC 9497. */ export declare const ristretto255_oprf: OPRF;
/**
