 ...
 * @module
 */ /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ import { sha512 } from "@jsr/noble__hashes/sha2.js";
import { abytes, concatBytes, hexToBytes } from "@jsr/noble__hashes/utils.js";
...
function ed25519_domain(data, ctx, phflag) {
  ...
  return concatBytes(asciiToBytes('SigEd25519 no Ed25519 collisions'), new Uint8Array([
    phflag ? 1 : 0,
    ctx.length
  ]), ctx, data);
}
...
/** Context version of ed25519 (ctx for domain separation). See {@link ed25519} */ export const ed25519ctx = /* @__PURE__ */ ed({
  domain: ed25519_domain
});
/** Prehashed version of ed25519. See {@link ed25519} */ export const ed25519ph = /* @__PURE__ */ ed({
  domain: ed25519_domain,
  prehash: sha512
});
/**
...
function map_to_curve_elligator2_edwards25519(u) {
  ...
  const [xd_inv, yd_inv] = FpInvertBatch(Fp, [
    xd,
    yd
  ], true); // batch division
  return {
...
/** Hashing to ed25519 points / field. RFC 9380 methods. */ export const ed25519_hasher = /* @__PURE__ */ (()=>createHasher(ed25519_Point, (scalars)=>map_to_curve_elligator2_edwards25519(scalars[0]), {
...
/** Hashing to ristretto255 points / field. RFC 9380 methods. */ export const ristretto255_hasher = {
  Point: _RistrettoPoint,
  /**
...
/** ristretto255 OPRF, defined in RFC 9497. */ export const ristretto255_oprf = /* @__PURE__ */ (()=>createORPF({
